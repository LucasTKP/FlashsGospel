              ...
              if(jornal.texto && jornal.foto_escritor && jornal.nome_escritor){
                  return (
                      <div key={index} className='mb-[15px] flex w-full gap-[20px] max-md:gap-[10px] relative'>
                          {
                              jornal.imagens ? <Image src={urlFor(jornal.imagens[0]).url()} width={550} height={200}  alt={'Capa do jornal'} className='max-2xl:w-[450px] max-xl:w-[400px] max-lg:w-[300px] max-md:w-[250px] max-sm:w-[200px] max-xs:w-[150px] rounded-[4px] border-black border-[1px] aspect-video'/> 
                          : 
