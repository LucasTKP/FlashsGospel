        ...
        <section>
            ...
            <div className='flex w-full justify-between max-lg:flex-wrap-reverse'>
                <div className='flex lg:flex-col w-[800px] px-20 max-xl:w-[700px] max-xl:px-14 max-lg:mx-auto max-lg:mt-[-100px] max-lg:gap-5 max-md:gap-2 max-md:justify-center max-sm:mt-[-50px] max-xs:hidden'>
                    <Image src={urlFor(heroData[0].image1).url()} alt='Primeira imagem da Hero Section' width={350} height={250} className='max-xl:w-[300px] max-md:w-[250px] max-sm:w-[200px]'></Image>
                    <Image src={urlFor(heroData[0].image2).url()} alt='Segunda imagem da Hero Section' width={350} height={250} className='md:ml-auto lg:mt-[-70px] max-xl:w-[300px] max-md:w-[250px] max-sm:w-[200px]'></Image>
                </div>
