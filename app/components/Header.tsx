...
export function Header({logo}: ImageAsset | any) {
    ...
    return (
        <header className='flex justify-between items-center py-8 container mx-auto items-center px-5'>
            ...
            <div className={`absolute ${isOpenMenu ? 'top-0 bg-neutral-300/80 backdrop-blur-md bottom-0' : 'top-[-1000px]'} right-0 left-0 top-0 duration-500 ease-in-out px-20 z-40 max-sm:px-10`}>
